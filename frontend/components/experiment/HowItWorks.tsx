...
const steps = [
  {
    ...
    desc: 'Work through each section at your own pace. The editor saves every keystroke — nothing is ever lost. You bring the story, we bring the compass.',
  },
  {
    num: 2,
    id: 'step-circle-2',
    title: 'Navigate and refine',
    desc: 'Run the ATS check and get specific guidance on what to improve, right where the issue is. Meridian flags the obstacles so you can fly clear.',
  },
  {
    num: 3,
    id: 'step-circle-3',
    title: 'Land and launch',
    desc: 'Download a clean PDF or share directly. Your resume is ready for every tracking system — and every human reader. Time to take off.',
  },
];
  ...
  return (
    ...
    >
      <div className="container">
        ...
        >
          Three waypoints to your destination.
        </motion.h2>
          ...
          {steps.map((step, i) => {
            ...
            return (
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={headerInView ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1], delay: 0.15 * i }}
              >
                {/* Numbered circle */}
                <div
                  id={step.id}
